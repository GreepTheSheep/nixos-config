      ...
      profiles = {
        "default" = {
          ...
          settings = {
            ...
            "intl.locale.requested" = "fr-FR"; # UI language
            "spellchecker.dictionary" = "fr-FR"; # Spellcheck language
            "intl.regional_prefs.use_os_locales" = true; # Don't use OS locale
            "intl.regional_prefs.locales" = "fr-FR"; # Use metric etc.
            ...
            "thunderbird.policies.runOncePerModification.extensionsInstall" =
              "https://addons.thunderbird.net/thunderbird/downloads/latest/grammar-and-spell-checker/latest/latest.xpi,https://addons.thunderbird.net/thunderbird/downloads/latest/dkim-verifier/latest/latest.xpi";
          };
