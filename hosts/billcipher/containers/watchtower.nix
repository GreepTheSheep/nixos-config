...

{
  ...
  {
    sops.secrets."docker/watchtower/billcipher-notification-url" = {};

    sops.templates."watchtower.env".content = ''
      WATCHTOWER_SCHEDULE=0 0 6 * * *
      WATCHTOWER_CLEANUP=true
      WATCHTOWER_NOTIFICATION_URL=${config.sops.placeholder."docker/watchtower/billcipher-notification-url"}
    '';
